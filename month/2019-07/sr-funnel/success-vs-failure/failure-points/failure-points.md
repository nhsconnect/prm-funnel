...
items:
  [
    { name: "GP2GP disabled", value: 121 },
    { name: "Patient not at surgery", value: 193 },
    { name: "Patient lookup failure", value: 0 },
    { name: "Requestor not current gp", value: 56 },
    { name: "Requestor not large message compliant", value: 3423 },
    { name: "Large message failure", value: 765 },
    { name: "Unable to generate EHR extract", value: 2 },
    { name: "Unable to send EHR extract", value: 234 },
    { name: "Unknown issue", value: 584 },
  ]
---

The same information is represented **[broken down into supplier pathways](/prm-funnel/month/2019-07/sr-funnel/success-vs-failure/failure-points/failure-pathways/failure-pathways.html)**
