...
items:
  [
    { name: "Unknown", value: 3363 },
    { name: "Duplicate EHR Extract received", value: 1634 },
    { name: "Large Message failure", value: 1394 },
    { name: "Failed to successfully generate EHR Extract", value: 305 },
    { name: "TPP attachment limit", value: 300 },
    { name: "Patient not at surgery", value: 173 },
    { name: "Spine system responded with an error", value: 152 },
    { 
      name: "A-B-A EHR Extract received and rejected due to non-data related reasons", 
      value: 134
    },
    { name: "Failed to successfully integrate EHR Extract", value: 130 },
    { 
    ...
    { name: "GP2GP Messaging is not enabled on this system", value: 46 },
    { 
      name: "Sender check indicates that Requester is not the patients current healthcare provider", 
      value: 10
    },
    { name: "Non A-B-A EHR Extract received and filed as attachment", value: 5 },
    { 
      name: "SDS lookup provided zero or more than one result to the query for each interaction", 
      value: 4
    },
    { name: "EHR Extract received without corresponding request", value: 2 },
  ]
---

A chart representing the details of GP2GP failures.

The same information is represented **[broken down into supplier pathways](/prm-funnel/month/2020-01/rr-funnel/gp2gp/errors/errors-pathways/errors-pathways.html)**
