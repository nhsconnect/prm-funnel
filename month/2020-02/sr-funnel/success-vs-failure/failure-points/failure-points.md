...
items:
  [
    { name: "GP2GP disabled", value: 78 },
    { name: "Patient not at surgery", value: 178 },
    { name: "Patient lookup failure", value: 0 },
    { name: "Requestor not current gp", value: 43 },
    { name: "Requestor not large message compliant", value: 2348 },
    { name: "Large message failure", value: 957 },
    { name: "Unable to generate EHR extract", value: 264 },
    { name: "Unable to send EHR extract", value: 325 },
    { name: "Unknown issue", value: 476 },
  ]
---

The same information is represented **[broken down into supplier pathways](/prm-funnel/month/2020-02/sr-funnel/success-vs-failure/failure-points/failure-pathways/failure-pathways.html)**
