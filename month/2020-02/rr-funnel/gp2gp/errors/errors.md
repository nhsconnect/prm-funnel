...
items:
  [
    { name: "Unknown", value: 2849 },
    { name: "Duplicate EHR Extract received", value: 1402 },
    { name: "Large Message failure", value: 1259 },
    { name: "Failed to successfully generate EHR Extract", value: 426 },
    { name: "TPP attachment limit", value: 181 },
    { name: "Patient not at surgery", value: 179 },
    { name: "Spine system responded with an error", value: 137 },
    ...
    { name: "GP2GP Messaging is not enabled on this system", value: 56 },
    {
    ...
    {
      name: "Non A-B-A EHR Extract received and filed as attachment",
      value: 15,
    },
    {
...
The same information is represented **[broken down into supplier pathways](/prm-funnel/month/2020-02/rr-funnel/gp2gp/errors/errors-pathways/errors-pathways.html)**
