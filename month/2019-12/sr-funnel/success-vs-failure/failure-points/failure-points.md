...
items:
  [
    { name: "GP2GP disabled", value: 33 },
    { name: "Patient not at surgery", value: 178 },
    { name: "Requestor not current gp", value: 47 },
    { name: "Requestor not large message compliant", value: 2171 },
    { name: "Large message failure", value: 761 },
    { name: "Unable to generate EHR extract", value: 95 },
    { name: "Unable to send EHR extract", value: 222 },
    { name: "Unknown issue", value: 371 },
  ]
---

The same information is represented **[broken down into supplier pathways](/prm-funnel/month/2019-12/sr-funnel/success-vs-failure/failure-points/failure-pathways/failure-pathways.html)**
