...
items:
  [
    { name: "GP2GP disabled", value: 126 },
    { name: "Patient not at surgery", value: 208 },
    { name: "Patient lookup failure", value: 0 },
    { name: "Requestor not current gp", value: 150 },
    { name: "Requestor not large message compliant", value: 4340 },
    { name: "Large message failure", value: 976 },
    { name: "Unable to generate EHR extract", value: 12 },
    { name: "Unable to send EHR extract", value: 304 },
    { name: "Unknown issue", value: 626 },
  ]
---

The same information is represented **[broken down into supplier pathways](/prm-funnel/month/2019-09/sr-funnel/success-vs-failure/failure-points/failure-pathways/failure-pathways.html)**
