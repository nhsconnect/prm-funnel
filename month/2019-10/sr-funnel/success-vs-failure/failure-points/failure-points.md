...
items:
  [
    { name: "GP2GP disabled", value: 139 },
    { name: "Patient not at surgery", value: 288 },
    { name: "Patient lookup failure", value: 0 },
    { name: "Requestor not current gp", value: 79 },
    { name: "Requestor not large message compliant", value: 3421 },
    { name: "Large message failure", value: 951 },
    { name: "Unable to generate EHR extract", value: 11 },
    { name: "Unable to send EHR extract", value: 402 },
    { name: "Unknown issue", value: 658 },
  ]
---

The same information is represented **[broken down into supplier pathways](/prm-funnel/month/2019-10/sr-funnel/success-vs-failure/failure-points/failure-pathways/failure-pathways.html)**
