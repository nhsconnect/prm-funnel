...
items:
  [
    { name: "GP2GP disabled", value: 88 },
    { name: "Patient not at surgery", value: 311 },
    { name: "Patient lookup failure", value: 0 },
    { name: "Requestor not current gp", value: 40 },
    { name: "Requestor not large message compliant", value: 3084 },
    { name: "Large message failure", value: 676 },
    { name: "Unable to generate EHR extract", value: 3 },
    { name: "Unable to send EHR extract", value: 137 },
    { name: "Unknown issue", value: 505 },
  ]
---

The same information is represented **[broken down into supplier pathways](/prm-funnel/month/2019-06/sr-funnel/success-vs-failure/failure-points/failure-pathways/failure-pathways.html)**
