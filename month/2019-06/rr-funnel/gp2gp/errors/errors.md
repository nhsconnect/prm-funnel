...
items:
  [
    { name: "Unknown", value: 4146},
    { name: "Duplicate EHR extract received", value: 1365 },
    { name: "Large message failure", value: 964 },
    { name: "TPP attachment limit", value: 348 },
    { name: "Patient not at surgery", value:  312},
    { name: "Failed to successfully generate EHR extract", value: 194 },
    { name: "A-B-A EHR extract received and rejected", value: 119 },
    { name: "Failed to successfully integrate EHR extract", value: 111 },
    { name: "Spine system responded with an error", value: 110 },
    { name: "Non A-B-A EHR extract received and rejected", value: 104 },
    { name: "GP2GP not enabled on this sytem", value: 84 },
    { name: "EHR extract message not well formed or not able to be processed", value: 47 },
    { name: "Requester is not the patients current healthcare provider", value: 16 },
    { name: "Non A-B-A EHR extract received and filed as an attachment", value: 13 },
...
The same information is represented **[broken down into supplier pathways](/prm-funnel/month/2019-06/rr-funnel/gp2gp/errors/errors-pathways/errors-pathways.html)**
