...
items:
  [
    { name: "Unknown", value: 4555 },
    { name: "Large message failure", value: 1169 },
    { name: "Duplicate EHR extract received", value: 1293 },
    { name: "TPP attachment limit", value: 351 },
    { name: "Failed to successfully generate EHR extract", value: 270 },
    { name: "Patient not at surgery", value: 200 },
    { name: "A-B-A EHR extract received and rejected", value: 102 },
    { name: "Spine system responded with an error", value: 126 },
    { name: "Non A-B-A EHR extract received and rejected", value: 102 },
    ...
    { name: "GP2GP not enabled on this sytem", value: 128 },
    {
...
The same information is represented **[broken down into supplier pathways](/prm-funnel/month/2019-05/rr-funnel/gp2gp/errors/errors-pathways/errors-pathways.html)**
